...
function go () {
  typish('#typer')
    ...
    .type('今天你还好吗~~em', '<span class="note">')
    .type('0', '<br>')
    .type('00', '<span class="blank">')
    .wait(10)
  ...
  // 第一个options
    ...
    .type(':', '<span class="blue">')
    .type('0', '<span class="blank">')
    .type("'muyun'", '<span class="green">')
    .wait(15)
    .del(6)
    .type("'暮云'", '<span class="green">')
    .type(',', '<span class="gray">')
    .type('0', '<br>')
    // 珊珊
    .type('0000', '<span class="blank">')
